...
<head>
    <meta charset="UTF-8">
    <title>Orders Recommendation</title>
        ...
        <div class="main-content">
            <div class="recommendations">
                <h2>
                    ...
                    <a href="{{ url('/') }}">
                        <button style="background-color:red;border-radius:3px;border:none;padding:5px 12px;color:white;position:relative;float:right;cursor:pointer">Back to Dashboard</button>
                    </a>
                </h2>
